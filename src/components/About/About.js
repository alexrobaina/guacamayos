...
import { useTranslation } from '../../util/translate'
import './about.scss'
              ...
              <div className="col-xs-12 col-md-6">
                <div className="card mTop50 card-our">
                  <div className="center-flex icons-padding">
                    <img
                      className="card-img-top img-nosotros"
                      src={nos.image}
                  ...
                  <div className="card-body body-our">
                    ...
                    <div className="center-flex">
                      <a target="_blank" href={nos.instaUrl}>
                        <img
                          className="card-img-top instagram"
                          src={instagram}
                          alt="fotografía de casamientos guacamayos"
                        />
                      </a>
                    ...
                    <div className="center-flex btn-nosotros"></div>
                  </div>
                </div>
              </div>
            )
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <p className="ser-guacamayos">
                  Ser guacamayos es volar sin límites. Desafiarse, moverse. Reírse del riesgo y los
                  impedimentos. Ser exótico, distinto. Adaptarse. Ser parte de un equipo, una
                  familia. Ser fiel a los sueños. Ganarle al miedo. Creer y confiar en que el amor
                  puede revolucionarlo todo.
                </p>
